...
6. Offrir à l'utilisateur la possibilité de dessiner sur la carte ([ol.interaction.Draw](https://geoadmin.github.io/ol3/apidoc/ol.interaction.Draw.html))
  - [Exemple dessin](http://tsauerwein.github.io/ol3/mapbox-gl-js/examples/draw-features.html)
